  ...
  return (
    <div className="site-shell">
      ...
      <footer><div className="container footer-grid">
        ...
        <div><h4>Quick Links</h4><a href="#about">About</a><a href="#care">Care Areas</a><a href="#why">Why Dr. Hasnain</a><a href="#faq">FAQs</a><a href="/whatsapp-community">Free WhatsApp Community</a></div>
