...
import { ArrowRight, CheckCircle2, MessageCircle, MapPin, ShieldCheck } from "lucide-react";

export const Route = createFileRoute("/whatsapp-community")({
  head: () => ({
    meta: [
      { title: "Free ENT WhatsApp Community | Dr. Hasnain Haider" },
      { name: "description", content: "Join Dr. Hasnain Haider's free WhatsApp community for useful ear, nose and throat health tips for Lahore residents." },
    ],
  }),
  ...
  return (
    <div className="community-page">
          ...
          <div className="container community-hero-grid">
            ...
            <div className="community-visual">
              <div className="community-logo-card">
                ...
                <strong>ENT HEALTH<br />COMMUNITY</strong>
                <span className="community-card-caption">Ear • Nose • Throat</span>
              </div>
              <div className="community-location"><MapPin size={17} /><span><strong>Lahore</strong><small>For local residents</small></span></div>
            </div>
          </div>
        </section>
        ...
        <section className="community-benefits">
          <div className="container">
            ...
            <div className="community-benefit-grid">
              <div className="community-benefit"><CheckCircle2 /><div><h3>Ear Health Tips</h3><p>Helpful awareness tips for common ear problems and symptoms.</p></div></div>
              <div className="community-benefit"><CheckCircle2 /><div><h3>Nose & Sinus Guidance</h3><p>Learn more about common nasal, sinus and allergy-related concerns.</p></div></div>
              <div className="community-benefit"><CheckCircle2 /><div><h3>Throat Health Awareness</h3><p>Useful information about common throat and voice-related problems.</p></div></div>
              <div className="community-benefit"><CheckCircle2 /><div><h3>Health Awareness Updates</h3><p>Simple medical education to help you understand ENT symptoms better.</p></div></div>
            </div>
          </div>
        </section>
        ...
        <section className="community-cta">
          <div className="container community-cta-card">
            <div>
              ...
              <p>Join the free WhatsApp community and receive useful ear, nose and throat awareness content.</p>
            </div>
            <a className="community-join-button light-community-button" href={communityLink} target="_blank" rel="noreferrer">
      ...
      <footer>
        ...
        <div className="container footer-bottom"><span>© 2026 Dr. Hasnain Haider. All rights reserved.</span><span>ENT • Head & Neck Surgical Care</span></div>
      </footer>
    </div>
  );
}
